...
namespace fmm
{
    ...
    {
        if(p[0] == value_function.dim_size[0] - 1 || p[0] == 0 ||
           p[1] == value_function.dim_size[1] - 1 || p[1] == 0)
            return 1;
    ...
    data_t solver_t::update_boundary_point_value(point_t p)
    {
        ...
        {
            // std::cout << "Boundary corner : " << p[0] << "|" << p[1] <<
            // std::endl;
        ...
        {
            // std::cout << "Boundary point : " << p[0] << "|" << p[1] <<
            // std::endl;
            if(p[0] == 0)
            {
        ...
        // std::cout << "New boundary value : " << std::max(val,
        // value_function(p[0], p[1])) << std::endl;
